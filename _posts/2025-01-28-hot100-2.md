        ...
        for(int i = 0; i < h; i++){
            for(int j = 0; j < w; j++){
                ...
                while(!q.empty()){
                    ...
                    q.pop();
                    for(int k = 0; k < 4; k++){
                        if(p.first + next[k][0] < h && p.second + next[k][1] < w &&
p.first + next[k][0] >= 0 && p.second + next[k][1] >= 0){
                            if(grid[p.first + next[k][0]][p.second + next[k][1]]=='1'
&& !vis[p.first + next[k][0]][p.second + next[k][1]]){
